...
def _main():
    log_dir = "logs/000/"
    train_annotation_path = "/home/shimeiz/cs_project/yolo_face_1/my_label.txt"
    ...
    # train_annotation_path is customized by Shimei Zhao
    val_split = 0.1
    ...
    if True:
        ...
        batch_size = 128 #before is 32
        print('Train on {} samples, val on {} samples, with batch size {}.'.format(num_train, num_val, batch_size))

        # data_generator_face_wrapper is customized
...
def create_face_yolo_model(input_shape, anchors,load_pretrained=True, freeze_body=2,
    ...
    # face_yolo_body is customized by Shimei Zhao
    ...
    # face_yolo_loss is customized by Shimei Zhao
...
# no anchors and num_classes by customized
...
def data_generator(annotation_lines, batch_size, input_shape):
    ...
    while True:
        ...
        for b in range(batch_size):
            ...
            # get_random_wider_data is customized
